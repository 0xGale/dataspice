...
`dataspice` makes it easier for you to get started documenting your data
so other people can find and re-use it. This documentation (metadata)
can also be used to:

  - Create a website for your data (like
    [pkgdown](https://github.com/r-lib/pkgdown) for your data)
  - Easily transition to a richer metadata standard to document your
    data even further
  - Integrate with Google’s [public datataset
    initiative](https://ai.googleblog.com/2017/01/facilitating-discovery-of-public.html)
    by automatically marking your website up with [Structured
    Data](https://developers.google.com/search/docs/guides/intro-structured-data)

The metadata `dataspice` helps you collect is based on
[Schema.org/Dataset](http://schema.org/Dataset) with an eye towards
exporting to richer [metadata
...
The number of mature salmon migrating from the marine environment to
freshwater streams is defined as escapement. Escapement data are the
enumeration of these migrating fish as they pass upstream, …
...
A few existing tools & data standards to help users in specific domains:
  ...
  - [Ecological Metadata
    ...
    (EML) (& [`eml2`](https://github.com/cboettig/eml2))
